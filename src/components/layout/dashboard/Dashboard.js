      ...
      >
        <div class="h-full px-3 py-4 overflow-y-auto bg-gray-800">
          <ul class="space-y-2 font-medium">
            <li>
                <span class="ms-3 text-white text-md">Dashboard</span>
            </li>
            <li>
            ...
            <li>
              ...
              >
                ...
                <span class="flex-1 ms-3 whitespace-nowrap">Add Money</span>
              </Link>
            </li>
            <li>
              ...
              >
                <FaHistory size={15} />
                <span class="flex-1 ms-3 whitespace-nowrap">Tranaction History</span>
              </Link>
            </li>
          </ul>

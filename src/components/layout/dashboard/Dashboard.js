...
const Dashboard = () => {
  ...
  useEffect(() => {
    function handleScroll() {
      ...
      if (scrollTop > 0) {
        setMarginTopClass("top-0");
      } else {
        setMarginTopClass("top-24");
      }
    }
  ...
  return (
    ...
    >
      ...
      <aside
        ...
        className={`fixed ${marginTopClass} left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0`}
        aria-label="Sidebar"
      >
